(() => {
  ...
  // extension/src/content/main.jsx
  var import_react9 = __toESM(require_react(), 1);
  var import_client = __toESM(require_client(), 1);

  // extension/src/lib/api.js
  async function analyzeMessage({ message, context, messageId, conversationId, messageHash }) {
  ...
  function parseMessageNodes(root = document) {
    ...
    return nodes.map((node, index) => {
      ...
      const id = node.dataset.id || node.getAttribute("data-id") || `${getConversationId()}-${index}-${text.slice(0, 16)}`;
      return {
        id,
        conversationId: getConversationId(),
        author: getAuthor(node),
        text,
        timestamp: node.querySelector("[data-pre-plain-text]")?.getAttribute("data-pre-plain-text") || null,
        node
      };
    }).filter(Boolean);
  }
  ...
  function setAnalysis(messageId, analysis) {
    state.analysisById[messageId] = analysis;
    emit();
  }
  function openAnalysisPane(messageId) {
    state.activeMessageId = messageId;
    emit();
  }
  function closeAnalysisPane() {
  ...
  // extension/src/ui/components/MessageDecorator.jsx
  var import_react2 = __toESM(require_react(), 1);

  // extension/src/ui/components/AnnotationBadge.jsx
  ...
  var badgeMap = {
    ...
    prediction: { icon: "\u{1F4CA}", tone: "bg-accent-500/20 text-accent-300 border-accent-400/40" },
    reasoning: { icon: "\u{1F9E0}", tone: "bg-success/20 text-success border-success/40" },
    error: { icon: "!", tone: "bg-danger/20 text-danger border-danger/40" }
  };
  function AnnotationBadge({ tone = "neutral", label, onHover, onLeave, onClick }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "button",
      {
        ...
        onClick,
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: config.icon })
      }
    );
  }
  ...
  function MessageDecorator({ analysis, onHover, onLeave, onOpen }) {
    const tone = analysis?.status === "error" ? "error" : analysis?.status === "ok" ? analysis.fastPass?.badges?.includes("prediction") ? "prediction" : "claim" : analysis?.status === "no_claims" ? "neutral" : "reasoning";
    const label = analysis?.status === "ok" ? "Claim analysis available" : analysis?.status === "error" ? "Analysis unavailable" : analysis?.status === "no_claims" ? "No strong claims" : "Analysis in progress";
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(AnnotationBadge, { tone, label, onHover, onLeave, onClick: onOpen });
  }

  // extension/src/ui/components/TooltipCard.jsx
  ...
  function TooltipCard({ tooltip }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "sl-text-[11px] sl-uppercase sl-tracking-[0.18em] sl-text-accent-300", children: tooltip.title }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "sl-mt-2 sl-text-sm sl-leading-6 sl-text-slate-200", children: tooltip.body })
        ]
      }
    );
  }

  // extension/src/ui/components/AnalysisPane.jsx
  var import_react7 = __toESM(require_react(), 1);

  // extension/src/ui/components/ClaimCard.jsx
  var import_react6 = __toESM(require_react(), 1);

  // extension/src/ui/components/ConfidenceBar.jsx
  var import_react4 = __toESM(require_react(), 1);
  var import_jsx_runtime4 = __toESM(require_jsx_runtime(), 1);
  function ConfidenceBar({ confidence = 0 }) {
    const pct = Math.max(0, Math.min(100, Math.round(confidence * 100)));
    const tone = pct >= 70 ? "bg-success" : pct >= 40 ? "bg-warning" : "bg-danger";
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "sl-space-y-1", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "sl-flex sl-items-center sl-justify-between sl-text-[11px] sl-uppercase sl-tracking-[0.18em] sl-text-slate-400", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "sl-h-2 sl-overflow-hidden sl-rounded-full sl-bg-white/10", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: `sl-h-full sl-rounded-full ${tone}`, style: { width: `${pct}%` } }) })
    ] });
  }

  // extension/src/ui/components/EvidenceList.jsx
  ...
  function EvidenceList({ evidence = [] }) {
    if (!evidence.length) {
      return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "sl-text-sm sl-text-slate-400", children: "No evidence retrieved yet." });
    }
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "sl-space-y-2", children: evidence.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "sl-rounded-2xl sl-border sl-border-white/10 sl-bg-white/5 sl-p-3", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "sl-flex sl-items-center sl-justify-between sl-gap-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "sl-text-sm sl-font-medium sl-text-white", children: item.title }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `sl-text-[11px] sl-uppercase sl-tracking-[0.18em] ${stanceTone[item.stance] || stanceTone.context}`, children: item.stance })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "sl-mt-2 sl-text-sm sl-leading-6 sl-text-slate-300", children: item.snippet })
    ] }, `${item.title}-${index}`)) });
  }
  ...
  function ClaimCard({ claim }) {
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("article", { className: "sl-space-y-4 sl-rounded-[28px] sl-border sl-border-white/10 sl-bg-white/5 sl-p-5", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "sl-flex sl-items-start sl-justify-between sl-gap-3", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "sl-text-[11px] sl-uppercase sl-tracking-[0.2em] sl-text-accent-300", children: claim.type }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h3", { className: "sl-mt-2 sl-text-base sl-font-semibold sl-text-white", children: claim.text })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "sl-text-sm sl-leading-6 sl-text-slate-300", children: claim.summary }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "sl-rounded-2xl sl-border sl-border-warning/20 sl-bg-warning/10 sl-p-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "sl-text-xs sl-uppercase sl-tracking-[0.18em] sl-text-warning", children: "Counterpoint" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "sl-mt-2 sl-text-sm sl-leading-6 sl-text-slate-200", children: claim.counter })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ConfidenceBar, { confidence: claim.confidence }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(EvidenceList, { evidence: claim.evidence })
    ] });
  }

  // extension/src/ui/components/AnalysisPane.jsx
  var import_jsx_runtime7 = __toESM(require_jsx_runtime(), 1);
  function AnalysisPane({ message, analysis, onClose }) {
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("aside", { className: "sl-fixed sl-right-0 sl-top-0 sl-z-[2147483646] sl-flex sl-h-screen sl-w-[380px] sl-flex-col sl-border-l sl-border-white/10 sl-bg-ink-950/95 sl-p-5 sl-text-white sl-shadow-signal sl-backdrop-blur", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "sl-flex sl-items-start sl-justify-between sl-gap-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "sl-text-[11px] sl-uppercase sl-tracking-[0.18em] sl-text-accent-300", children: "SignalLayer" }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h2", { className: "sl-mt-2 sl-text-lg sl-font-semibold", children: "Message analysis" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", className: "sl-rounded-full sl-border sl-border-white/10 sl-px-3 sl-py-1 sl-text-sm sl-text-slate-300", onClick: onClose, children: "Close" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "sl-mt-5 sl-rounded-[28px] sl-border sl-border-white/10 sl-bg-white/5 sl-p-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "sl-text-[11px] sl-uppercase sl-tracking-[0.18em] sl-text-slate-400", children: "Original message" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "sl-mt-3 sl-text-sm sl-leading-6 sl-text-slate-200", children: message?.text || "No message selected." })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "sl-mt-4 sl-flex-1 sl-space-y-4 sl-overflow-y-auto sl-pr-1", children: [
        !analysis && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "sl-text-sm sl-text-slate-400", children: "Deep analysis is loading." }),
        analysis?.status === "error" && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "sl-rounded-[24px] sl-border sl-border-danger/30 sl-bg-danger/10 sl-p-4 sl-text-sm sl-text-slate-200", children: "SignalLayer could not reach the analysis backend. Keep the badge as a hint and retry when the service is available." }),
        analysis?.status === "no_claims" && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "sl-rounded-[24px] sl-border sl-border-white/10 sl-bg-white/5 sl-p-4 sl-text-sm sl-text-slate-200", children: "No strong claim candidates were detected in this message." }),
        analysis?.claims?.map((claim) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ClaimCard, { claim }, claim.id))
      ] })
    ] });
  }

  // extension/src/ui/components/SummaryBar.jsx
  var import_react8 = __toESM(require_react(), 1);
  var import_jsx_runtime8 = __toESM(require_jsx_runtime(), 1);
  function SummaryBar({ title, totalMessages, analyzedMessages, backendStatus }) {
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "sl-fixed sl-right-5 sl-top-5 sl-z-[2147483645] sl-w-[320px] sl-rounded-[28px] sl-border sl-border-white/10 sl-bg-ink-900/92 sl-p-4 sl-text-white sl-shadow-signal sl-backdrop-blur", children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: "sl-text-[11px] sl-uppercase sl-tracking-[0.2em] sl-text-accent-300", children: "SignalLayer" }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("h1", { className: "sl-mt-2 sl-text-base sl-font-semibold", children: title }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "sl-mt-4 sl-grid sl-grid-cols-3 sl-gap-3 sl-text-center", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "sl-rounded-2xl sl-bg-white/5 sl-p-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: "sl-text-xl sl-font-semibold", children: totalMessages }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: "sl-text-[10px] sl-uppercase sl-tracking-[0.18em] sl-text-slate-400", children: "Messages" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "sl-rounded-2xl sl-bg-white/5 sl-p-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: "sl-text-xl sl-font-semibold", children: analyzedMessages }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: "sl-text-[10px] sl-uppercase sl-tracking-[0.18em] sl-text-slate-400", children: "Analyzed" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "sl-rounded-2xl sl-bg-white/5 sl-p-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: "sl-text-xs sl-font-semibold sl-uppercase sl-tracking-[0.18em]", children: backendStatus }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: "sl-text-[10px] sl-uppercase sl-tracking-[0.18em] sl-text-slate-400", children: "Backend" })
        ] })
      ] })
    ] });
  }
  ...
  var decoratorRoots = /* @__PURE__ */ new Map();
  var analyzedHashes = /* @__PURE__ */ new Set();
  ...
  function App() {
    const snapshot = import_react9.default.useSyncExternalStore(subscribe, getState, getState);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(TooltipCard, { tooltip: snapshot.tooltip }),
      snapshot.activeMessageId && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
        AnalysisPane,
        {
  ...
  function ensureDecoratorAnchor(message) {
    ...
    if (!anchor) {
      ...
      const target = message.node.querySelector("div.copyable-text") || message.node.querySelector("span.selectable-text") || message.node;
  ...
  function renderDecorator(message) {
    ...
    const root = existing || (0, import_client.createRoot)(anchor);
    if (!existing) {
        ...
        MessageDecorator,
        {
          ...
          onHover: (event) => {
            ...
            showTooltip({
              ...
              body: claim?.summary || (analysis?.status === "error" ? "Backend unavailable. Using local signal only." : analysis?.status === "no_claims" ? "No strong claim detected." : "Fast pass detected a message worth reviewing.")
            });
          },
          onLeave: () => hideTooltip(),
  ...
  async function analyzeAndRender(message, allMessages) {
    ...
    renderDecorator(message);
    try {
      const context = allMessages.filter((item) => item.id !== message.id).slice(-5).map((item) => ({
        id: item.id,
        text: item.text,
        author: item.author
      }));
  ...
  function bootstrap() {
    ...
    (0, import_client.createRoot)(appRoot).render(/* @__PURE__ */ (0, import_jsx_runtime9.jsx)(App, {}));
    scanMessages();
    initObserver();
  }
  bootstrap();
